...
namespace EldritchArcana
{
    ...
    public enum ModMetamagic
    {
        ...
        ElementalForce = 0x00100000,
        Elemental = ElementalFire | ElementalCold | ElementalElectricity | ElementalAcid | ElementalForce
    }
    ...
    static class MetamagicFeats
    {
        ...
        static BlueprintFeature CreateMetamagicFeat(ModMetamagic metamagic, String assetId, String friendlyName, String description, Sprite icon, BlueprintComponent logic = null, params BlueprintComponent[] extra)
        {
            ...
            feat.SetNameDescriptionIcon(String.Format(RES.MetamagicFeatGeneralName_info, friendlyName), description, icon);
            Main.library.AddAsset(feat, assetId);

            Main.SafeLoad(() => CreateMetamagicRods(feat, metamagic, friendlyName, logic), RES.MetamagicRodsName_info);
            return feat;
        }
    ...
    public class ElementalMetamagic : RuleInitiatorLogicComponent<RulePrepareDamage>, IInitiatorRulebookHandler<RuleCastSpell>
    {
        ...
        private static SpellDescriptor ElementToSpellDescriptor(DamageEnergyType element)
        {
            switch (element)
            {
                ...
                case DamageEnergyType.Magic:
                    return SpellDescriptor.Force;
                default:
                    return SpellDescriptor.Fire;
            }
        }
    ...
    class MyPatchClass
    {
        static MethodBase TargetMethod()
        {
            return AccessTools.Method(
                typeof(BlueprintSpellbook), "MaxPossibleSpellLevel",
                new Type[] {
                            typeof(int),
    ...
    static class MetamagicHelper_DefaultCost_Patch
    {
        internal static bool Prefix(Metamagic metamagic, ref int __result)
        {
            switch ((ModMetamagic)metamagic)
            {
                ...
                case ModMetamagic.ElementalForce:
                    __result = 1;
                    return false;
